...
<div class="container-fluid">
	...
	<div class="col-md-12" style=" padding-left: 0px; padding-right: 0px; background:#0E5E6F;">
		<button class="btn btn-secondary btn-block btn-sm" type="button" id="bid" style=" background:#0E5E6F;">Make my Bid</button>
	</div>
	<div id="bid-frm">
		<div class="col-md-12" style="padding-left: 0px;">
			<form id="manage-bid">
				...
				<div class="row justify-content-between bidbut" style=" padding-left: 15px;">
					<button class="btn col-sm-4 btn-primary btn-block btn-sm mr-2" style=" background:#0E5E6F;color:#fff;">Submit</button><br>
					<button class="btn col-sm-4 btn-secondary mt-0 btn-block btn-sm" type="button" id="cancel_bid">Cancel</button>
				</div>
			</form>
		</div>
	</div>
